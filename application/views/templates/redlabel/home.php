...
<div class="col-sm-3  left-side"> 
   ...
   <div id="home-slider" class="carousel slide col-sm-9 right-side " data-ride="carousel" >
...
<?php } ?>
<div class="container" style="margin-top:600px" id="home-page">
    <div class="row">
        <div class="col-md-3">
            <div class="filter-sidebar">
                <div class="title">
